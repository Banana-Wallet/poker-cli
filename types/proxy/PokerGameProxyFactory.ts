...
export interface PokerGameProxyFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface PokerGameProxyFactory extends BaseContract {
  connect(runner?: ContractRunner | null): PokerGameProxyFactory;
  waitForDeployment(): Promise<this>;

  interface: PokerGameProxyFactoryInterface;
  ...
  getAddress: TypedContractMethod<
    [_singleton: AddressLike, _salt: BigNumberish, initializer: BytesLike],
    [string],
    "view"
  >;

  getBytecode: TypedContractMethod<
    [_owner: AddressLike, _foo: BigNumberish],
    [string],
    "view"
  >;
